...
st.set_page_config(
    ...
    page_icon="https://github.com/NehaDesai1704/Feelify/blob/main/Music%20web/Feelify%20.png",
    layout="wide"
)
...
with col1:
    st.image("https://github.com/NehaDesai1704/Feelify/blob/main/Music%20web/Feelify%20.png", width=80)
with col2:
    st.title("🎵 Feelify")
